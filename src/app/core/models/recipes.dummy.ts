...
export const RecipesDummy: Recipe[] = [
  ...
  {id: 1, title: 'Nudelauflauf',nutritions: {calories: '13', protein: '34', carbs: '66'}, portionSize: 2, calories: 500, cookTime: 30, categories: [{id: 0, category_title: 'd'}, {id: 1, category_title: 'eeee'}, {id: 2, category_title: 'ddd'}], level: 'einfach', score: 4, img: 'assets/img/recipes/nudelauflauf.jpg',
