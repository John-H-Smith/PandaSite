...
export const RecipesDummy: Recipe[] = [
  ...
  {id: 2, title: 'd', instructions: '', infos: {portionSize: 3, calories: 600, cookTime: 30, categories: [{id: 0, category_title: 'd'}]}, level: 3, taste: 3, img: 'assets/img/recipes/nudelauflauf.jpg'}
